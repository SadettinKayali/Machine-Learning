...
Udemy 31. Python ile Geri Eleme (Backward Elimination)
"""
...
# Sistemin doğruluğunu bozan verileri çıkarmak
...
model=sm.OLS(boy,X_list).fit() # istatistiksel değerleri çıkarmaya yarıyor
print(model.summary())             

# P değeri yüksek olan kolon eleniliyor. o yüzden 4. kolon elendi
...
# P değeri yüksek olan kolon eleniliyor. o yüzden 5. kolon elendi
